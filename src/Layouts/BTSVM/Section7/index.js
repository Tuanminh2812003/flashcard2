            ...
            <div className="Section7" style={{backgroundColor: "#E3DAD2"}}>
                <div className="container">
                    <div className="Section7__inner">
                        ...
                        Bạn hãy thiết kế một video/poster hoặc lá thư để thể hiện chủ đề: Đề xuất những biện pháp bảo tồn và quảng bá hình ảnh di sản Quần thể danh thắng Tràng An. 
                        </div>
                        <div className="Section7__inner__disc">
                        Những sản phẩm tốt sẽ được cấp Giấy chứng nhận “Cá nhân có đề xuất xuất sắc trong bảo tồn và quảng bá hình ảnh di sản văn hóa Quần thể danh thắng Tràng An”. 
                        </div>
                        <form>
